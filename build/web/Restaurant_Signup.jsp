<%-- 
    Document   : Restaurant_Signup
    Created on : 29 Apr, 2020, 3:25:18 PM
    Author     : HP
--%>
  ...
  box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.5);
          ...
          <script>
            ...
            function check()
            {
                ...
                var rpass=document.getElementById("rpass1").value;
                var rpass1=document.getElementById("rpass11").value;
              ...
              //  var rprofile=document.getElementById("rprofile").src;
                ...
                if(city=="" || rname=="" || remail=="" || rdesc=="" || rpass=="" || rpass1=="" || raddr=="" || rmob=="" || rloc=="" || rmin=="" || rstart=="" || rend=="" || rcharge=="")
            {
            ...
            if(emailflag==true && passflag==true && emptyflag==true)
                restaurantSignup();
            else
            {
                document.getElementById("error").style.color="red";
            ...
            function restaurantSignup()
            {
                ...
                else
                {
                    ...
                    xhr.open("POST", "./Restaurant_Signup_Servlet", true);
         ...
         <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h1 style="font-family: 'Barrio', cursive; color: #fff;">Restaurant Sign Up</h1>
                 <!--   <a href="#"></a>
                ...
                <div class="col-sm-12">
                    ...
                    <form id="form2" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-row">
                            ...
                            <input type="text" name="rname1" id="rname1" class="form-control col-sm-9" /> 
                        </div>
                        ...
                        <div class="form-group form-row">
                            ...
                            <input type="text" name="remail1" id="remail1" class="form-control col-sm-9" /> 
                        </div>
                        
                         <div class="form-group form-row">
                            <label for="rpass1" class="col-sm-3">Password</label>
                            <input type="password" name="rpass1" id="rpass1" class="form-control col-sm-9" /> 
                        </div>
                        
                        <div class="form-group form-row">
                            <label for="rpass11" class="col-sm-3">Confirm Password</label>
                            <input type="password" name="rpass11" id="rpass11" class="form-control col-sm-9" /> 
                        </div>
