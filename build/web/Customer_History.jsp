        ...
        <script>
                ...
                xhr.onreadystatechange = function ()
                {
                    if (xhr.readyState === 4 && xhr.status == 200)
                    {
                       ...
                       // alert(r);
                        ...
                        ans = ans + "</tbody>";
                        ans = ans + "</table>";
                        document.getElementById("d23").innerHTML = ans;

                    }
                };

                xhr.open("GET", "./Customer_Fetch_History", true);
            ...
            function viewDetails(bid)
            {
                ...
                ans=ans+"</tr>";
                    ...
                    ans=ans+"</tbody>";
                    ans=ans+"</table>";
                    document.getElementById("d24").innerHTML=ans;
         ...
         <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h1 style="font-family: 'Barrio', cursive; color: #fff;">History</h1>
                 <!--   <a href="#"></a>
