...
@MultipartConfig
public class Restaurant_Signup_Servlet extends HttpServlet 
{
       ...
       try
       {
        ...
        // Receive ALL Files  
          ...
          String rdesc = request.getParameter("rdesc1");
           ...
           String rpass = request.getParameter("rpass1");
...
//System.out.println("File name"+filename1);
         ...
         // out.println("<h3>Text Data</h3>");
          ...
          ResultSet rs = DBLoader.executeQuery("select * from restaurant where restaurant_name=\'"+rname+"\' and city=\'"+city+"\'");
          ...
          else
          {
            ...
            rs.insertRow();
          int rid;
            ResultSet rs2=DBLoader.executeQuery("select max(restaurant_id) as rid from restaurant");
            if(rs2.next())
            {
               rid=rs2.getInt("rid");
