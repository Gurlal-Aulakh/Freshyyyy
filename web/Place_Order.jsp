...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.5);
        ...
        <script>
            ...
            function getCuisine()
            {
                ...
                xhttp.onreadystatechange = function ()
                {
                    if (this.readyState == 4 && this.status == 200)
                    {
                        ...
                        {
                            var singleobj = arr[i];
                            ans = ans + "<div class\"col-sm-3\">" + "<input type=\"checkbox\" name=\"" + singleobj["cuisine_id"] + "\" value=\"" + singleobj["cuisine_name"] + "\"/>" + singleobj["cuisine_name"] + "</div>";
                            /// <div class\"col-sm-3\">  +"</div>"
                        }

                        document.getElementById("l10").innerHTML = ans;
            ...
            function viewWithCheckbox()
            {
                var ans = "";
                var formdata = new FormData();

                var controls = document.getElementById("form-order").elements;
                var flag = 0;
                var cids = "";
                    ...
                    if (xhr.readyState === 4 && xhr.status == 200)
                    {
                       ...
                       // alert(r);
                        ...
                        for (var i = 0; i < result.length; i++)
                        {
                            ...
                            {
                                if (newids[j] == result[i]["restaurant_id"])
                                {
                                    flag = false;
                                    break;
                                }
                            ...
                            if (flag == true)
                            {
                                newids[c] = result[i]["restaurant_id"];
                                c++;
                            }
                        }
                        restaurantListWithCheckBox();
                    }
                };

                xhr.open("POST", "./View_With_CheckBbox", true);
            ...
            function restaurantListWithCheckBox()
            {
...
//                  alert(newids[i]);
                ...
                xhr.onreadystatechange = function ()
                {
                    if (xhr.readyState === 4 && xhr.status == 200)
                    {
                        ...
                        {    
                            ...
                            ans = ans + "<tr onclick=\"showRestaurantDetail("+singleobj["restaurant_id"]+")\">";
                            ans = ans + "<td>" + j + "</td>";
                            ans = ans + "<td>" + "<img src=\"" + singleobj["photo_wide"] + "\" width='100' height='100' />" + "</td>";
                            ans = ans + "<td>" + singleobj["restaurant_name"] + "</td>";
                            ans = ans + "<td>" + singleobj["address"] + "</td>";
                            ans = ans + "<td>" + singleobj["mobileno"] + "</td>";
                            ans = ans + "<td>" + singleobj["min_order_delivery"] + "</td>";
                ...
                xhr.open("GET", "./Restaurant_List_With_Checkbox?cids="+rids, true);
            ...
            {
                window.location.href="Place_Order_2.jsp?index="+index;
            }
         ...
         <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h1 style="font-family: 'Barrio', cursive; color: #fff;">Place Order</h1>
                 <!--   <a href="#"></a>
                ...
                <div class="col-sm-6">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select  name="city" id="city" onchange="" class="col-sm-12">
                                <option>All</option>                               
                        ...
                        <div class="form-group">
                            <input type="button" value="View by City" class="btn-outline-primary btn-lg col-sm-3 offset-3" onclick="restaurantList()" />                     
                        </div>
                    </form>
                ...
                <div class="col-sm-6">
                    ...
                    <form id="form-order" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label id="l10" name="l10" class="offset-3"></label>

                        </div>

                        <div class="form-group">
                            <input type="button" value="View by Cuisine" class="btn-outline-primary btn-lg col-sm-6 offset-3" onclick="viewWithCheckbox()" />
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div id="error1" style="color:red" class="offset-3"><label id="l2" class="offset-3"></label></div>
